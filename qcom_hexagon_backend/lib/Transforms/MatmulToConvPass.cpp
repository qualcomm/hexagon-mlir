...
struct MatmulToConv final : public OpRewritePattern<linalg::MatmulOp> {
  ...
  LogicalResult matchAndRewrite(linalg::MatmulOp op,
    ...
    constexpr int64_t kCroutonWidthInt8 = 8;
    constexpr int64_t kCroutonWidthF16 = 4;
    ...
    // Crouton Width based on the datatype
    auto cW = elemA.isInteger(8) ? kCroutonWidthInt8 : kCroutonWidthF16;
