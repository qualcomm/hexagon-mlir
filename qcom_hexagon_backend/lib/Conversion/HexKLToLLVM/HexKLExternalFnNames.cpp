...
std::string hexkl::getHmxRmToAhF16FnName() {
  static const std::string fnName =
      "hexkl_micro_hmx_layout_flat_to_activation_f16";
  return fnName;
}

std::string hexkl::getHmxRmToWhF16FnName() {
  static const std::string fnName =
      "hexkl_micro_hmx_layout_flat_to_weight_fp16";
  return fnName;
}
...
std::string hexkl::getHmxAhToRmF16FnName() {
  static const std::string fnName =
      "hexkl_micro_hmx_layout_activation_to_flat_f16";
  return fnName;
}
