...
std::string hexagonmem::getAllocFnName(bool isCroutonType) {
  if (isCroutonType) {
    static const std::string allocFnName = "hexagon_runtime_alloc_2d";
    return allocFnName;
  } else {
...
std::string hexagonmem::getDeallocFnName(bool isCroutonType) {
  if (isCroutonType) {
    static const std::string deallocFnName = "hexagon_runtime_free_2d";
...
std::string hexagonmem::getMemrefToCroutonFnName() {
  return "hexagon_runtime_build_crouton";
}

std::string hexagonmem::getCroutonToMemrefFnName() {
  return "hexagon_runtime_get_contiguous_memref";
}
