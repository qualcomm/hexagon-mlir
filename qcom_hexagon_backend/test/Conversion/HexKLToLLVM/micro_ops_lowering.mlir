...
func.func @rm_to_ah(%hmx: memref<?xi8, 1>) {
  ...
  // CHECK: llvm.call @hexkl_micro_hmx_layout_flat_to_activation_f16({{.*}}) : (!llvm.ptr, i32, i32) -> ()
...
func.func @rm_to_wh(%hmx: memref<?xi8, 1>, %wt: memref<64x64xf16>) {
  ...
  // CHECK: llvm.call @hexkl_micro_hmx_layout_flat_to_weight_fp16({{.*}}) : (!llvm.ptr, i32, !llvm.ptr, i32, i32, i32) -> ()
...
func.func @ah_to_rm(%hmx: memref<?xi8, 1>) {
  ...
  // CHECK: llvm.call @hexkl_micro_hmx_layout_activation_to_flat_f16({{.*}}) : (!llvm.ptr, i32, i32) -> ()
