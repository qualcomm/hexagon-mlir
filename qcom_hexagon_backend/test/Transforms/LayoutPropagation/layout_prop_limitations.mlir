...
// This example demonstrates the PACK_MULTIRESULT_SUPPORT limitation described in ExtendPackUnpackFrontier.cpp
func.func @no_multiresult_generic(%arg0: tensor<10xf32>, %arg1: tensor<10xf32>) -> (tensor<5x2xf32>, tensor<10xf32>) {
  ...
  %dest = tensor.empty() : tensor<5x2xf32>
  %packed = linalg.pack %sum_and_prod#0
    inner_dims_pos = [0]
    inner_tiles = [2]
    into %dest : tensor<10xf32> -> tensor<5x2xf32>

  return %packed, %sum_and_prod#1 : tensor<5x2xf32>, tensor<10xf32>
}

// CHECK: func.func @no_multiresult_generic(%[[A0:.+]]: tensor<10xf32>, %[[A1:.+]]: tensor<10xf32>)
// CHECK: %[[GENERIC:.*]]:2 = linalg.generic
// CHECK: %[[PACK:.*]] = linalg.pack %[[GENERIC]]#0
// CHECK: return %[[PACK:.*]]
