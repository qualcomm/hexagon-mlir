...
// CHECK-SAME: inner_dims_pos = [0, 1] inner_tiles = [4, 4]
// Covers the **UNPACK_THROUGH_REDUCE** issue described in ExtendPackUnpackFrontier.cpp
// CHECK: %[[REDUCE_POST:.*]] = linalg.generic
// CHECK-SAME: ins(%[[UNPACK]] : tensor<8x8xi32>
// CHECK: return %[[REDUCE_POST]] : tensor<8xi32>
